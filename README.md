...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cyclonedx-bom-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15042&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cyclonedx-bom-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cyclonedx-bom` can be installed with:

```
conda install cyclonedx-bom
```

It is possible to list all of the versions of `cyclonedx-bom` available on your platform with:
